			...
			<Center as="section" paddingX={isSmallerThan890 ? PADDING_IPAD : PADDING_DESKTOP}>
				<Center flexDir="column" gap="4" maxW={isSmallerThan890 ? "90%" : "80%"}>
					...
					<Text textAlign={"center"} fontSize="lg" lineHeight={"1.75rem"} fontWeight="300">
						Découvrez notre sélection exclusive de chaussures remises à neuf et prêtes à être portées. Ces modèles populaires ont été soigneusement
						nettoyés et restaurés, offrant une seconde vie à des chaussures de qualité. Explorez notre collection de sneakers tendance et redécouvrez
						le style avec des chaussures qui ont retrouvé tout leur éclat.
					</Text>
				</Center>
			</Center>
